...
### 🔘 Dynamic KPI Toggle (Global Feature)
This page also includes the **custom toggle button** allowing users to switch between:
- `Total Orders`
- `Total Profit`
- `Total Sales`

All relevant charts (except YoY summary cards) adapt based on the selected metric.
